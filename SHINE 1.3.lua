-- T.ME/ABUSERMTA | DISCORD.GG/GASMASK
ShineMenu = {
    button = {},
    label = {}
}
...
ShineInfo = guiCreateLabel(0.02, 0.06, 0.97, 0.12, "SHINE MENU - Version 1.3 | Telegram: @ABUSERMTA - Discord: https://discord.gg/GasMask\n\nOnline Players: 85 | Interior: 65 | Dimension: 72", true, ShineBG)
...
InfoDevelopersDiscord = guiCreateLabel(0.05, 0.26, 0.52, 0.17, "discord.gg/GasMask | sirabuser", true, SettingsTab)
